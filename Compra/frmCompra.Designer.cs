...
partial class frmCompra
{
    ...
    private DataGridView dgvCompra = null!;
    ...
    {
        lblTitulo = new Label();         lbl1 = new Label(); txt1 = new TextBox();         lbl2 = new Label(); txt2 = new TextBox();         lbl3 = new Label(); txt3 = new TextBox(); chkEstado = new CheckBox(); btnNuevo = new Button(); btnRegistrar = new Button(); btnActualizar = new Button(); btnEliminar = new Button(); btnHabilitar = new Button(); dgvCompra = new DataGridView();
        ((System.ComponentModel.ISupportInitialize)dgvCompra).BeginInit(); SuspendLayout();
        lblTitulo.AutoSize = true; lblTitulo.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold); lblTitulo.Location = new Point(250, 28); lblTitulo.Text = "Mantenimiento Cruzado - Compra";
        lbl1.AutoSize = true; lbl1.Location = new Point(55, 109); lbl1.Text = "Fecha de compra";
        ...
        lbl3.AutoSize = true; lbl3.Location = new Point(55, 155); lbl3.Text = "Proveedor";
        ...
        dgvCompra.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize; dgvCompra.Location = new Point(55, 265); dgvCompra.Name = "dgvCompra"; dgvCompra.Size = new Size(760, 250);
        AutoScaleDimensions = new SizeF(7F, 15F); AutoScaleMode = AutoScaleMode.Font; BackColor = Color.FromArgb(242, 242, 242); ClientSize = new Size(875, 550); Controls.Add(dgvCompra); Controls.Add(btnHabilitar); Controls.Add(btnEliminar); Controls.Add(btnActualizar); Controls.Add(btnRegistrar); Controls.Add(btnNuevo); Controls.Add(chkEstado); Controls.Add(txt1); Controls.Add(lbl1); Controls.Add(txt2); Controls.Add(lbl2); Controls.Add(txt3); Controls.Add(lbl3); Controls.Add(lblTitulo); Name = "frmCompra"; StartPosition = FormStartPosition.CenterScreen; Text = "frmCompra";
        ((System.ComponentModel.ISupportInitialize)dgvCompra).EndInit(); ResumeLayout(false); PerformLayout();
    }
}
