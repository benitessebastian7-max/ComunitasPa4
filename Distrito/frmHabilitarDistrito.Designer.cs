...
partial class frmHabilitarDistrito
{
    ...
    private void InitializeComponent()
    {
        ...
        lblTitulo.AutoSize = true; lblTitulo.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold); lblTitulo.Location = new Point(185, 28); lblTitulo.Text = "Habilitar Distrito";
        ...
        AutoScaleDimensions = new SizeF(7F, 15F); AutoScaleMode = AutoScaleMode.Font; BackColor = Color.FromArgb(242, 242, 242); ClientSize = new Size(715, 470); Controls.Add(dgvRegistros); Controls.Add(btnHabilitar); Controls.Add(lblTitulo); Name = "frmHabilitarDistrito"; StartPosition = FormStartPosition.CenterScreen; Text = "frmHabilitarDistrito";
