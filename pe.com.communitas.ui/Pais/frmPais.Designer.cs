...
partial class frmPais
{
    ...
    private DataGridView dgvPais = null!;
    ...
    {
        lblTitulo = new Label();         lbl1 = new Label(); txt1 = new TextBox(); chkEstado = new CheckBox(); btnNuevo = new Button(); btnRegistrar = new Button(); btnActualizar = new Button(); btnEliminar = new Button(); btnHabilitar = new Button(); dgvPais = new DataGridView();
        ((System.ComponentModel.ISupportInitialize)dgvPais).BeginInit(); SuspendLayout();
        lblTitulo.AutoSize = true; lblTitulo.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold); lblTitulo.Location = new Point(250, 28); lblTitulo.Text = "Mantenimiento Simple - País";
        ...
        dgvPais.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize; dgvPais.Location = new Point(55, 219); dgvPais.Name = "dgvPais"; dgvPais.Size = new Size(760, 250);
        AutoScaleDimensions = new SizeF(7F, 15F); AutoScaleMode = AutoScaleMode.Font; BackColor = Color.FromArgb(242, 242, 242); ClientSize = new Size(875, 504); Controls.Add(dgvPais); Controls.Add(btnHabilitar); Controls.Add(btnEliminar); Controls.Add(btnActualizar); Controls.Add(btnRegistrar); Controls.Add(btnNuevo); Controls.Add(chkEstado); Controls.Add(txt1); Controls.Add(lbl1); Controls.Add(lblTitulo); Name = "frmPais"; StartPosition = FormStartPosition.CenterScreen; Text = "frmPais";
        ((System.ComponentModel.ISupportInitialize)dgvPais).EndInit(); ResumeLayout(false); PerformLayout();
    }
}
