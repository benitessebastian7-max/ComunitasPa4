...
partial class frmRol
{
    ...
    private DataGridView dgvRol = null!;
    ...
    {
        lblTitulo = new Label();         lbl1 = new Label(); txt1 = new TextBox(); chkEstado = new CheckBox(); btnNuevo = new Button(); btnRegistrar = new Button(); btnActualizar = new Button(); btnEliminar = new Button(); btnHabilitar = new Button(); dgvRol = new DataGridView();
        ((System.ComponentModel.ISupportInitialize)dgvRol).BeginInit(); SuspendLayout();
        lblTitulo.AutoSize = true; lblTitulo.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold); lblTitulo.Location = new Point(250, 28); lblTitulo.Text = "Mantenimiento Simple - Rol";
        ...
        dgvRol.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize; dgvRol.Location = new Point(55, 219); dgvRol.Name = "dgvRol"; dgvRol.Size = new Size(760, 250);
        AutoScaleDimensions = new SizeF(7F, 15F); AutoScaleMode = AutoScaleMode.Font; BackColor = Color.FromArgb(242, 242, 242); ClientSize = new Size(875, 504); Controls.Add(dgvRol); Controls.Add(btnHabilitar); Controls.Add(btnEliminar); Controls.Add(btnActualizar); Controls.Add(btnRegistrar); Controls.Add(btnNuevo); Controls.Add(chkEstado); Controls.Add(txt1); Controls.Add(lbl1); Controls.Add(lblTitulo); Name = "frmRol"; StartPosition = FormStartPosition.CenterScreen; Text = "frmRol";
        ((System.ComponentModel.ISupportInitialize)dgvRol).EndInit(); ResumeLayout(false); PerformLayout();
    }
}
