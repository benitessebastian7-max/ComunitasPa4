...
partial class frmProducto
{
    ...
    private DataGridView dgvProducto = null!;
    ...
    {
        lblTitulo = new Label();         lbl1 = new Label(); txt1 = new TextBox();         lbl2 = new Label(); txt2 = new TextBox();         lbl3 = new Label(); txt3 = new TextBox();         lbl4 = new Label(); txt4 = new TextBox();         lbl5 = new Label(); txt5 = new TextBox();         lbl6 = new Label(); txt6 = new TextBox();         lbl7 = new Label(); txt7 = new TextBox();         lbl8 = new Label(); txt8 = new TextBox();         lbl9 = new Label(); txt9 = new TextBox(); chkEstado = new CheckBox(); btnNuevo = new Button(); btnRegistrar = new Button(); btnActualizar = new Button(); btnEliminar = new Button(); btnHabilitar = new Button(); dgvProducto = new DataGridView();
        ((System.ComponentModel.ISupportInitialize)dgvProducto).BeginInit(); SuspendLayout();
        lblTitulo.AutoSize = true; lblTitulo.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold); lblTitulo.Location = new Point(250, 28); lblTitulo.Text = "Mantenimiento Cruzado - Producto";
        lbl1.AutoSize = true; lbl1.Location = new Point(55, 109); lbl1.Text = "ISBN";
        txt1.Location = new Point(160, 105); txt1.Name = "txt1"; txt1.Size = new Size(220, 23);
        lbl2.AutoSize = true; lbl2.Location = new Point(430, 109); lbl2.Text = "Título";
        txt2.Location = new Point(555, 105); txt2.Name = "txt2"; txt2.Size = new Size(235, 23);
        lbl3.AutoSize = true; lbl3.Location = new Point(55, 155); lbl3.Text = "Descripción";
        txt3.Location = new Point(160, 151); txt3.Name = "txt3"; txt3.Size = new Size(220, 23);
        lbl4.AutoSize = true; lbl4.Location = new Point(430, 155); lbl4.Text = "Precio compra";
        txt4.Location = new Point(555, 151); txt4.Name = "txt4"; txt4.Size = new Size(235, 23);
        lbl5.AutoSize = true; lbl5.Location = new Point(55, 201); lbl5.Text = "Precio venta";
        txt5.Location = new Point(160, 197); txt5.Name = "txt5"; txt5.Size = new Size(220, 23);
        lbl6.AutoSize = true; lbl6.Location = new Point(430, 201); lbl6.Text = "Fecha de publicación";
        txt6.Location = new Point(555, 197); txt6.Name = "txt6"; txt6.Size = new Size(235, 23);
        lbl7.AutoSize = true; lbl7.Location = new Point(55, 247); lbl7.Text = "Proveedor";
        txt7.Location = new Point(160, 243); txt7.Name = "txt7"; txt7.Size = new Size(220, 23);
        lbl8.AutoSize = true; lbl8.Location = new Point(430, 247); lbl8.Text = "Categoría";
        txt8.Location = new Point(555, 243); txt8.Name = "txt8"; txt8.Size = new Size(235, 23);
        lbl9.AutoSize = true; lbl9.Location = new Point(55, 293); lbl9.Text = "Editorial";
