<%@ Page Title="Communitas Libros | Empleados" Language="C#" MasterPageFile="~/templates/Plantilla.Master" AutoEventWireup="true" CodeFile="FormEmpleado.aspx.cs" Inherits="pe.com.communitas.ui.empleado.FormEmpleado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid mt-2 px-4">
        ...
        <div class="text-center mb-5">
            <h2 class="page-title"><i class="fa-solid fa-users-gear me-2"></i>Gestión de Personal</h2>
        </div>
        ...
        <div class="admin-card mx-auto mb-5">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label"><i class="fa-regular fa-id-card me-1 text-muted"></i>Documento:</label>
                        <asp:TextBox ID="txtDoc" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><i class="fa-regular fa-calendar me-1 text-muted"></i>Fec. Ingreso:</label>
                        <asp:TextBox ID="txtFecIng" runat="server" TextMode="Date" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="mb-3">
                        <div class="form-check mt-4 p-3 bg-light rounded border border-light-subtle">
                            <asp:CheckBox ID="chkEst" runat="server" Text=" Empleado Habilitado" CssClass="form-check-input ms-1 fw-bold text-success"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label"><i class="fa-solid fa-mobile-screen me-1 text-muted"></i>Celular:</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label"><i class="fa-regular fa-user me-1 text-muted"></i>Usuario (Sistema):</label>
                        <asp:TextBox ID="txtUsu" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><i class="fa-solid fa-key me-1 text-muted"></i>Clave:</label>
                        <asp:TextBox ID="txtCla" runat="server" TextMode="Password" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>

                <div class="col-md-4">
                    <div class="mb-3">
                        <label class="form-label"><i class="fa-solid fa-sack-dollar me-1 text-muted"></i>Sueldo:</label>
                        <asp:TextBox ID="txtSue" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><i class="fa-regular fa-clock me-1 text-muted"></i>Horas:</label>
                        <asp:TextBox ID="txtHor" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:DropDownList ID="ddlEstCiv" runat="server" CssClass="form-select"></asp:DropDownList>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive mb-5">
            <asp:GridView ID="gvEmpleado" runat="server" OnRowCommand="gvEmpleado_RowCommand" AutoGenerateColumns="false" CssClass="table custom-table table-hover align-middle text-center" GridLines="None">
                <Columns>
