<%@ Page Title="Communitas Libros | Estado de Categorías" Language="C#" MasterPageFile="~/templates/Plantilla.Master" AutoEventWireup="true" CodeBehind="FormHabilitarCategoria.aspx.cs" Inherits="pe.com.communitas.ui.categoria.FormHabilitarCategoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="text-center mb-5">
            <h2 class="page-title"><i class="fa-solid fa-bookmark me-2"></i>Estado de Categorías</h2>
        </div>
        ...
        <div class="admin-card mx-auto" style="max-width: 700px;">
            ...
            <div class="table-responsive">
                <asp:GridView ID="gvHabilitarCategoria" runat="server" OnRowCommand="gvHabilitarCategoria_RowCommand" AutoGenerateColumns="false" CssClass="table custom-table table-hover align-middle text-center" GridLines="None">
                    <Columns>
