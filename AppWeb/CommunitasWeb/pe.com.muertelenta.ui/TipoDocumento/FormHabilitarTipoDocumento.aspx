<%@ Page Title="Communitas Libros | Estado Tipos Doc" Language="C#" MasterPageFile="~/templates/Plantilla.Master" AutoEventWireup="true" CodeBehind="FormHabilitarTipoDocumento.aspx.cs" Inherits="pe.com.communitas.ui.tipodocumento.FormHabilitarTipoDocumento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4 mb-5">
        <div class="text-center mb-5">
            <h2 class="page-title"><i class="fa-solid fa-id-card me-2"></i>Estado de Tipos de Documento</h2>
        </div>
        <div class="d-flex justify-content-center gap-3 mb-5">
            <asp:Button ID="btnHabilitar" runat="server" Text="Habilitar" CssClass="btn-action btn-habilitar" OnClick="btnHabilitar_Click" OnClientClick="return confirm('¿Habilitar este tipo?');" />
            <asp:Button ID="btnDeshabilitar" runat="server" Text="Deshabilitar" CssClass="btn-action btn-deshabilitar" OnClick="btnDeshabilitar_Click" OnClientClick="return confirm('¿Deshabilitar este tipo?');" /> 
        ...
        <div class="admin-card mx-auto" style="max-width: 600px;">
            ...
            <div class="table-responsive">
                <asp:GridView ID="gvHabilitarTipoDoc" runat="server" OnRowCommand="gvHabilitarTipoDoc_RowCommand" AutoGenerateColumns="false" CssClass="table custom-table table-hover align-middle text-center" GridLines="None">
                    <Columns>
