<%@ Page Title="Communitas Libros | Tipos de Documento" Language="C#" MasterPageFile="~/templates/Plantilla.Master" AutoEventWireup="true" CodeBehind="FormTipoDocumento.aspx.cs" Inherits="pe.com.communitas.ui.tipodocumento.FormTipoDocumento" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!-- Copia exactamente el mismo <style> que usamos en FormRol.aspx -->
    <style>
        ...
        .form-control { border: 1px solid #dcd3c6; border-radius: 6px; background-color: #fdfbf7; font-family: 'Lora', serif; transition: all 0.3s ease; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4 mb-5">
        <div class="text-center mb-4">
            <h2 class="page-title"><i class="fa-solid fa-id-card me-2"></i>Gestión de Tipo de Documento</h2>
        </div>
        <div class="admin-card mx-auto mb-4" style="max-width: 600px;">
            <div class="card-body">
                <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label text-end fw-bold form-label-custom">Código:</label>
                    <div class="col-sm-9"><asp:TextBox ID="txtCod" runat="server" CssClass="form-control"></asp:TextBox></div>
                </div>
                <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label text-end fw-bold form-label-custom">Documento:</label>
                    <div class="col-sm-9"><asp:TextBox ID="txtNom" runat="server" CssClass="form-control"></asp:TextBox></div>
                </div>
                <div class="mb-2 row align-items-center">
                    <label class="col-sm-3 col-form-label text-end fw-bold form-label-custom">Estado:</label>
                    <div class="col-sm-9">
                        <div class="form-check mt-2">
                            <asp:CheckBox ID="chkEst" runat="server" Text=" Activo" CssClass="form-check-input ms-1 fw-bold text-success" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center flex-wrap gap-3 mb-5">
            ...
            <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn-action btn-eliminar" OnClick="btnEliminar_Click" OnClientClick="return confirm('¿Quieres eliminar este tipo?');" />
        ...
        <div class="table-responsive mx-auto" style="max-width: 600px;">
            <asp:GridView ID="gvTipoDoc" runat="server" OnRowCommand="gvTipoDoc_RowCommand" AutoGenerateColumns="false" CssClass="table custom-table table-hover align-middle text-center" GridLines="None">
                <Columns>
