            ...
            <div class="row">
                ...
                <div class="col-md-6 pe-md-4">
                    <div class="mb-3 row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtCod" runat="server" CssClass="form-control"></asp:TextBox></div>
                    </div>
                    <div class="mb-3 row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtRazSoc" runat="server" CssClass="form-control"></asp:TextBox></div>
                    </div>
                    <div class="mb-3 row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtRuc" runat="server" CssClass="form-control"></asp:TextBox></div>
                    </div>
                    <div class="mb-3 row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtDir" runat="server" CssClass="form-control"></asp:TextBox></div>
                    </div>
                </div>
                ...
                <div class="col-md-6 ps-md-4">
                    <div class="mb-3 row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtTel" runat="server" CssClass="form-control"></asp:TextBox></div>
                    </div>
                    <div class="mb-3 row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtCor" runat="server" TextMode="Email" CssClass="form-control"></asp:TextBox></div>
                    </div>
