<%@ Page Title="Communitas Libros | Roles" Language="C#" MasterPageFile="~/templates/Plantilla.Master" AutoEventWireup="true" CodeBehind="FormRol.aspx.cs" Inherits="pe.com.communitas.ui.rol.FormRol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4 mb-5">
        <div class="text-center mb-4">
            <h2 class="page-title"><i class="fa-solid fa-user-shield me-2"></i>Gestión de Roles</h2>
        </div>
        ...
        <div class="admin-card mx-auto mb-4" style="max-width: 600px;">
            <div class="card-body">
                ...
                <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label text-end fw-bold form-label-custom">Nombre del Rol:</label>
                ...
                <div class="mb-2 row align-items-center">
                    ...
                    <div class="col-sm-9">
                        <div class="form-check mt-2">
                            <asp:CheckBox ID="chkEst" runat="server" Text=" Rol Activo" CssClass="form-check-input ms-1 fw-bold text-success" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center flex-wrap gap-3 mb-5">
            ...
            <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn-action btn-eliminar" OnClick="btnEliminar_Click" OnClientClick="return confirm('¿Quieres eliminar este rol?');" />
        ...
        <div class="table-responsive mx-auto" style="max-width: 600px;">
            <asp:GridView ID="gvRol" runat="server" OnRowCommand="gvRol_RowCommand" AutoGenerateColumns="false" CssClass="table custom-table table-hover align-middle text-center" GridLines="None">
                <Columns>
