<%@ Page Title="Communitas Libros | Distritos" Language="C#" MasterPageFile="~/templates/Plantilla.Master" AutoEventWireup="true" CodeBehind="FormDistrito.aspx.cs" Inherits="pe.com.communitas.ui.distrito.FormDistrito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4 mb-5">
        ...
        <div class="text-center mb-4">
            <!-- Icono cambiado a mapa -->
            <h2 class="page-title"><i class="fa-solid fa-map-location-dot me-2"></i>Gestión de Distritos</h2>
        </div>
                ...
                <div class="mb-2 row align-items-center">
                    ...
                    <div class="col-sm-9">
                        <div class="form-check mt-2">
                            <asp:CheckBox ID="chkEst" runat="server" Text=" Distrito Activo" CssClass="form-check-input ms-1 fw-bold text-success" />
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-center flex-wrap gap-3 mb-5">
            ...
            <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn-action btn-eliminar" OnClick="btnEliminar_Click" OnClientClick="return confirm('¿Quieres eliminar este distrito?');" />
            <asp:Button ID="btnHabilitar" runat="server" Text="Habilitar" CssClass="btn-action btn-habilitar" OnClick="btnHabilitar_Click" />
        </div>
        
        <!-- Tabla reducida para que se vea mejor con pocos datos -->
        <div class="table-responsive mx-auto" style="max-width: 600px;">
            <asp:GridView ID="gvDistrito" runat="server" OnRowCommand="gvDistrito_RowCommand" AutoGenerateColumns="false" CssClass="table custom-table table-hover align-middle text-center" GridLines="None">
                <Columns>
                    <asp:BoundField DataField="codigo" HeaderText="Cód" />
                    <asp:BoundField DataField="nombre" HeaderText="Nombre del Distrito" />
