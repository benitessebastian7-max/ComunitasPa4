<%@ Page Title="Communitas Libros | Estado de Distritos" Language="C#" MasterPageFile="~/templates/Plantilla.Master" AutoEventWireup="true" CodeBehind="FormHabilitarDistrito.aspx.cs" Inherits="pe.com.communitas.ui.distrito.FormHabilitarDistrito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4 mb-5">
        <div class="text-center mb-5">
            <h2 class="page-title"><i class="fa-solid fa-map-location-dot me-2"></i>Estado de Distritos</h2>
        </div>

        <div class="d-flex justify-content-center gap-3 mb-5">
            <asp:Button ID="btnHabilitar" runat="server" Text="Habilitar" CssClass="btn-action btn-habilitar" OnClick="btnHabilitar_Click" OnClientClick="return confirm('¿Estás seguro de que quieres habilitar este distrito?');" />
            <asp:Button ID="btnDeshabilitar" runat="server" Text="Deshabilitar" CssClass="btn-action btn-deshabilitar" OnClick="btnDeshabilitar_Click" OnClientClick="return confirm('¿Estás seguro de que quieres deshabilitar este distrito?');" /> 
        ...
        <div class="admin-card mx-auto" style="max-width: 600px;">
            ...
            <div class="table-responsive">
                <!-- Se retiró la columna de país porque distrito no la tiene -->
                <asp:GridView ID="gvHabilitarDistrito" runat="server" OnRowCommand="gvHabilitarDistrito_RowCommand" AutoGenerateColumns="false" CssClass="table custom-table table-hover align-middle text-center" GridLines="None">
                    <Columns>
