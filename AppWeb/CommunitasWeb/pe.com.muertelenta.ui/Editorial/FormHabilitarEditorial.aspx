<%@ Page Title="Communitas Libros | Estado de Editoriales" Language="C#" MasterPageFile="~/templates/Plantilla.Master" AutoEventWireup="true" CodeBehind="FormHabilitarEditorial.aspx.cs" Inherits="pe.com.communitas.ui.editorial.FormHabilitarEditorial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4 mb-5">
        <div class="text-center mb-5">
            <h2 class="page-title"><i class="fa-solid fa-building me-2"></i>Estado de Editoriales</h2>
        </div>

        <div class="d-flex justify-content-center gap-3 mb-5">
            <asp:Button ID="btnHabilitar" runat="server" Text="Habilitar" CssClass="btn-action btn-habilitar" OnClick="btnHabilitar_Click" OnClientClick="return confirm('¿Estás seguro de que quieres habilitar esta editorial?');" />
            <asp:Button ID="btnDeshabilitar" runat="server" Text="Deshabilitar" CssClass="btn-action btn-deshabilitar" OnClick="btnDeshabilitar_Click" OnClientClick="return confirm('¿Estás seguro de que quieres deshabilitar esta editorial?');" /> 
        ...
        <div class="admin-card mx-auto" style="max-width: 800px;">
            <asp:HiddenField ID="hfCodigoSeleccionado" runat="server" />
            
            <div class="table-responsive">
                <asp:GridView ID="gvHabilitarEditorial" runat="server" OnRowCommand="gvHabilitarEditorial_RowCommand" AutoGenerateColumns="false" CssClass="table custom-table table-hover align-middle text-center" GridLines="None">
                    <Columns>
