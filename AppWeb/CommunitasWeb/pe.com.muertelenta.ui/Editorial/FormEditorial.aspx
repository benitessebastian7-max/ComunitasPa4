<%@ Page Title="Communitas Libros | Editoriales" Language="C#" MasterPageFile="~/templates/Plantilla.Master" AutoEventWireup="true" CodeBehind="FormEditorial.aspx.cs" Inherits="pe.com.communitas.ui.editorial.FormEditorial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4 mb-5">
        ...
        <div class="text-center mb-4">
            <h2 class="page-title"><i class="fa-solid fa-building me-2"></i>Gestión de Editoriales</h2>
        </div>
                ...
                <div class="mb-2 row align-items-center">
                    ...
                    <div class="col-sm-9">
                        <div class="form-check mt-2">
                            <asp:CheckBox ID="chkEst" runat="server" Text=" Editorial Activa" CssClass="form-check-input ms-1 fw-bold text-success" />
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-center flex-wrap gap-3 mb-5">
            ...
            <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn-action btn-eliminar" OnClick="btnEliminar_Click" OnClientClick="return confirm('¿Quieres eliminar esta editorial?');" />
        ...
        <div class="table-responsive mx-auto" style="max-width: 800px;">
            <asp:GridView ID="gvEditorial" runat="server" OnRowCommand="gvEditorial_RowCommand" AutoGenerateColumns="false" CssClass="table custom-table table-hover align-middle text-center" GridLines="None">
                <Columns>
