...
partial class frmTipoPago
{
    ...
    private DataGridView dgvTipoPago = null!;
    ...
    {
        lblTitulo = new Label();         lbl1 = new Label(); txt1 = new TextBox(); chkEstado = new CheckBox(); btnNuevo = new Button(); btnRegistrar = new Button(); btnActualizar = new Button(); btnEliminar = new Button(); btnHabilitar = new Button(); dgvTipoPago = new DataGridView();
        ((System.ComponentModel.ISupportInitialize)dgvTipoPago).BeginInit(); SuspendLayout();
        lblTitulo.AutoSize = true; lblTitulo.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold); lblTitulo.Location = new Point(250, 28); lblTitulo.Text = "Mantenimiento Simple - Tipo de pago";
        ...
        dgvTipoPago.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize; dgvTipoPago.Location = new Point(55, 219); dgvTipoPago.Name = "dgvTipoPago"; dgvTipoPago.Size = new Size(760, 250);
        AutoScaleDimensions = new SizeF(7F, 15F); AutoScaleMode = AutoScaleMode.Font; BackColor = Color.FromArgb(242, 242, 242); ClientSize = new Size(875, 504); Controls.Add(dgvTipoPago); Controls.Add(btnHabilitar); Controls.Add(btnEliminar); Controls.Add(btnActualizar); Controls.Add(btnRegistrar); Controls.Add(btnNuevo); Controls.Add(chkEstado); Controls.Add(txt1); Controls.Add(lbl1); Controls.Add(lblTitulo); Name = "frmTipoPago"; StartPosition = FormStartPosition.CenterScreen; Text = "frmTipoPago";
        ((System.ComponentModel.ISupportInitialize)dgvTipoPago).EndInit(); ResumeLayout(false); PerformLayout();
    }
}
